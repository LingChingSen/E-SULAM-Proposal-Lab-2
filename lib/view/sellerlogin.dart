...
void initState(){
         ...
         leading: IconButton(
          ...
          onPressed: (){
            Navigator.pushReplacement(
              context,MaterialPageRoute(builder: (context)=>MainScreen(user: widget.user,seller:widget.seller))
            );
          },
        ),
 ...
 Future<void> _onLogin() async {
   ...
   if(_email.isEmpty || _password.isEmpty){
    ...
    http.post(
        Uri.parse("https://crimsonwebs.com/s271738/bunplanet/php/sellerlogin.php"),
      ...
      if (response.body == "failed") {
        ...
        Fluttertoast.showToast(
          ...
          Navigator.push(context,
            MaterialPageRoute(builder: (content) => SellerScreen(seller:seller,user:widget.user)));
      }
    });
                                                         }
  }
